...
class Upload {
    ...
    /**
     * Set this variable to false in the init() public function if you don't want to check the MIME
     ...
     */
    public function upload($file, $lang = 'pt_BR') {
