        ...
        <fieldset>
            ...
            <legend>Pesquisar</legend>
                ...
                <span class="row">
                    ...
                    <?php echo CHtml::activeTextField($form, 'module', array('style' => 'width: 300px;')); ?>
                </span>
            
                <span class="row">
                    <?php echo CHtml::activeLabel($form, 'action', array('class' => 'preField')); ?>
                    <?php echo CHtml::activeTextField($form, 'action', array('style' => 'width: 300px;')); ?>
                </span>
        ...
        <fieldset>
    		...
    		<table class="datagrid" cellpadding="0" cellspacing="0" border="0">
    			...
    			<tr class="header">
    				...
    				<th class="alignLeft">Módulo</th>
					<th class="alignLeft">Descrição do módulo</th>
					<th class="alignLeft">Ação</th>
					<th class="alignLeft">Descrição da ação</th>
    			...
    			<?php if (isset($list) && count($list) > 0) { ?>
    				...
    				<tr class="<?php echo((count($list)-1 == $index) ? 'lastRow' : ''); ?>">
    					...
    					<td class="alignLeft"><?php echo($listItem->module); ?></td>
    					<td class="alignLeft"><?php echo($listItem->module_description); ?></td>
    					<td class="alignLeft"><?php echo($listItem->action); ?></td>
    					<td class="alignLeft"><?php echo($listItem->action_description); ?></td>
