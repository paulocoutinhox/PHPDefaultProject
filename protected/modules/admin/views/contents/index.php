        ...
        <fieldset>
            ...
            <legend>Pesquisar</legend>
                ...
                <span class="row">
                    ...
                    <?php echo CHtml::activeTextField($form, 'title', array('style' => 'width: 200px;')); ?>
                </span>
        ...
        <fieldset>
    		...
    		<table class="datagrid" cellpadding="0" cellspacing="0" border="0">
    			...
    			<tr class="header">
    				...
    				<th class="alignLeft">Título</th>
    				<th class="alignLeft">Tag</th>
    			...
    			<?php if (isset($list) && count($list) > 0) { ?>
    				...
    				<tr class="<?php echo((count($list)-1 == $index) ? 'lastRow' : ''); ?>">
    					...
    					<td class="alignLeft"><?php echo($listItem->title); ?></td>
    					<td class="alignLeft"><?php echo($listItem->tag); ?></td>
